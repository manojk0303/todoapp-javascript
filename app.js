...
//     newl.innerHTML += '<a class= "delete" href="#">delete</a>'
//     ul.appendChild(newl)
//     })
// }
...
//     }
//     tasks.forEach(function(task){
//         console.log(e.target.parentElement.textContent,task+"delete")

//         if(e.target.parentElement.textContent === task+"delete"){
